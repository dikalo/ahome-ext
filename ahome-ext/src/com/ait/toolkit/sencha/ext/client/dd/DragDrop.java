...
public class DragDrop extends JsObject {
	...
	private static native void init() /*-{
		...
		$wnd.Ext.dd.DragDrop.prototype.startDrag = function(x, y) {
			var ddJ = this.ddJ;
			if (ddJ != null)
				ddJ.@com.ait.toolkit.sencha.ext.client.dd.DragDrop::startDrag(II)(x,y);
		}
		...
		$wnd.Ext.dd.DragDrop.prototype.onDragDrop = function(e, id) {
			...
			if (ddJ != null) {
				var eJ = @com.ait.toolkit.sencha.shared.client.core.EventObject::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
				if (typeof id == 'string') {
					ddJ.@com.ait.toolkit.sencha.ext.client.dd.DragDrop::onDragDrop(Lcom/ait/toolkit/sencha/shared/client/core/EventObject;Ljava/lang/String;)(eJ, id);
				} else {
					var items = @com.ait.toolkit.sencha.ext.client.dd.DragDrop::convertToDragDropArray(Lcom/google/gwt/core/client/JavaScriptObject;)(id);
					ddJ.@com.ait.toolkit.sencha.ext.client.dd.DragDrop::onDragDrop(Lcom/ait/toolkit/sencha/shared/client/core/EventObject;[Lcom/ait/toolkit/sencha/ext/client/dd/DragDrop;)(eJ, items);
				}
			}
		}
		...
		$wnd.Ext.dd.DragDrop.prototype.onDragEnter = function(e, id) {
			...
			if (ddJ != null) {
				var eJ = @com.ait.toolkit.sencha.shared.client.core.EventObject::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
				if (typeof id == 'string') {
					ddJ.@com.ait.toolkit.sencha.ext.client.dd.DragDrop::onDragEnter(Lcom/ait/toolkit/sencha/shared/client/core/EventObject;Ljava/lang/String;)(eJ, id);
				} else {
					var items = @com.ait.toolkit.sencha.ext.client.dd.DragDrop::convertToDragDropArray(Lcom/google/gwt/core/client/JavaScriptObject;)(id);
					ddJ.@com.ait.toolkit.sencha.ext.client.dd.DragDrop::onDragEnter(Lcom/ait/toolkit/sencha/shared/client/core/EventObject;[Lcom/ait/toolkit/sencha/ext/client/dd/DragDrop;)(eJ, items);
				}
			}
		}
		...
		$wnd.Ext.dd.DragDrop.prototype.onDragOut = function(e, id) {
			...
			if (ddJ != null) {
				var eJ = @com.ait.toolkit.sencha.shared.client.core.EventObject::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
				if (typeof id == 'string') {
					ddJ.@com.ait.toolkit.sencha.ext.client.dd.DragDrop::onDragOut(Lcom/ait/toolkit/sencha/shared/client/core/EventObject;Ljava/lang/String;)(eJ, id);
				} else {
					var items = @com.ait.toolkit.sencha.ext.client.dd.DragDrop::convertToDragDropArray(Lcom/google/gwt/core/client/JavaScriptObject;)(id);
					ddJ.@com.ait.toolkit.sencha.ext.client.dd.DragDrop::onDragOut(Lcom/ait/toolkit/sencha/shared/client/core/EventObject;[Lcom/ait/toolkit/sencha/ext/client/dd/DragDrop;)(eJ, items)
				}
			}
		}
		...
		$wnd.Ext.dd.DragDrop.prototype.onDragOver = function(e, id) {
			...
			if (ddJ != null) {
				var eJ = @com.ait.toolkit.sencha.shared.client.core.EventObject::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(e);
				if (typeof id == 'string') {
					ddJ.@com.ait.toolkit.sencha.ext.client.dd.DragDrop::onDragOver(Lcom/ait/toolkit/sencha/shared/client/core/EventObject;Ljava/lang/String;)(eJ, id);
				} else {
					var items = @com.ait.toolkit.sencha.ext.client.dd.DragDrop::convertToDragDropArray(Lcom/google/gwt/core/client/JavaScriptObject;)(id);
					ddJ.@com.ait.toolkit.sencha.ext.client.dd.DragDrop::onDragOver(Lcom/ait/toolkit/sencha/shared/client/core/EventObject;[Lcom/ait/toolkit/sencha/ext/client/dd/DragDrop;)(eJ, items);
				}
			}
		}
	...
	private native JavaScriptObject doGetGroups() /*-{
		...
		var group;
		var arr = @com.ait.toolkit.core.client.JsoHelper::createJavaScriptArray()();
		for (group in groups) {
			arr.push(group);
		}
		return arr;
	...
	public native Paddings getPadding() /*-{
		...
		return @com.ait.toolkit.sencha.shared.client.core.Paddings::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(padding);
	}-*/;
