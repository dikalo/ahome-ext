...
public class LoadEvent extends EventObject {
	 ...
	 */
	private static Type<LoadHandler> TYPE = new Type<LoadHandler>(EVENT_NAME,
			null);
	...
	public LoadEvent(TreeStore store, NodeInterface node,
			List<BaseModel> records, boolean successful,
