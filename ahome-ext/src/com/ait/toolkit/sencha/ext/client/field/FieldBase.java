 ...
 */
package com.ait.toolkit.sencha.ext.client.field;
...
import com.ait.toolkit.sencha.ext.client.events.form.DirtyChangeHandler;
import com.ait.toolkit.sencha.ext.client.events.form.SpecialKeyHandler;
import com.ait.toolkit.sencha.ext.client.events.form.ValidityChangeHandler;
import com.ait.toolkit.sencha.ext.client.events.form.WritableChangeHandler;
...
public class FieldBase extends Field {
	...
	public native HandlerRegistration addSpecialKeyHandler(
		...
		var fn = function(f, e) {
			...
			var event = @com.ait.toolkit.sencha.ext.client.events.form.SpecialKeyEvent::new(Lcom/ait/toolkit/sencha/ext/client/field/FieldBase;Lcom/google/gwt/core/client/JavaScriptObject;)(field,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.form.SpecialKeyHandler::onSpecialKey(Lcom/ait/toolkit/sencha/ext/client/events/form/SpecialKeyEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.form.SpecialKeyEvent::EVENT_NAME;
	...
	public native HandlerRegistration addWritableChangeHandler(
		...
		var fn = function(f, read, e) {
			var field = @com.ait.toolkit.sencha.ext.client.field.FieldBase::new(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
			var event = @com.ait.toolkit.sencha.ext.client.events.form.WritableChangeEvent::new(Lcom/ait/toolkit/sencha/ext/client/field/FieldBase;ZLcom/google/gwt/core/client/JavaScriptObject;)(field, read, e)
			handler.@com.ait.toolkit.sencha.ext.client.events.form.WritableChangeHandler::onWritableChange(Lcom/ait/toolkit/sencha/ext/client/events/form/WritableChangeEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.form.WritableChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addChangeHandler(ChangeHandler handler)/*-{
		...
		var fn = function(f, newValue, oldValue, e) {
			...
			var field = @com.ait.toolkit.sencha.ext.client.field.FieldBase::new(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
			var event = @com.ait.toolkit.sencha.ext.client.events.form.ChangeEvent::new(Lcom/ait/toolkit/sencha/ext/client/field/FieldBase;Ljava/lang/String;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(field,nV,oV,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.form.ChangeHandler::onChange(Lcom/ait/toolkit/sencha/ext/client/events/form/ChangeEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.form.ChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addDirtyChangeHandler(
		...
		var fn = function(f, isDirty, e) {
			var field = @com.ait.toolkit.sencha.ext.client.field.FieldBase::new(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
			var event = @com.ait.toolkit.sencha.ext.client.events.form.DirtyChangeEvent::new(Lcom/ait/toolkit/sencha/ext/client/field/FieldBase;ZLcom/google/gwt/core/client/JavaScriptObject;)(field,isDirty,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.form.DirtyChangeHandler::onDirtyChange(Lcom/ait/toolkit/sencha/ext/client/events/form/DirtyChangeEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.form.DirtyChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addValidityChangeHandler(
		...
		var fn = function(f, isValid, e) {
			var field = @com.ait.toolkit.sencha.ext.client.field.FieldBase::new(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
			var event = @com.ait.toolkit.sencha.ext.client.events.form.ValidityChangeEvent::new(Lcom/ait/toolkit/sencha/ext/client/field/FieldBase;ZLcom/google/gwt/core/client/JavaScriptObject;)(field,isValid,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.form.ValidityChangeHandler::onValidityChange(Lcom/ait/toolkit/sencha/ext/client/events/form/ValidityChangeEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.form.ValidityChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
