...
import com.ait.toolkit.sencha.ext.client.events.button.GlyphChangeHandler;
import com.ait.toolkit.sencha.ext.client.events.button.IconChangeHandler;
import com.ait.toolkit.sencha.ext.client.events.button.MenuHideHandler;
import com.ait.toolkit.sencha.ext.client.events.button.MenuShowHandler;
import com.ait.toolkit.sencha.ext.client.events.button.MenuTriggerOutHandler;
import com.ait.toolkit.sencha.ext.client.events.button.MenuTriggerOverHandler;
import com.ait.toolkit.sencha.ext.client.events.button.MouseOverHandler;
import com.ait.toolkit.sencha.ext.client.events.button.TextChangeHandler;
import com.ait.toolkit.sencha.ext.client.events.button.ToggleHandler;
import com.ait.toolkit.sencha.ext.client.laf.Alignment;
import com.ait.toolkit.sencha.ext.client.laf.ButtonScale;
import com.ait.toolkit.sencha.ext.client.tip.Tip;
...
public class Button extends Component {
	...
	private native void init()/*-{
		...
		@com.ait.toolkit.sencha.ext.client.ui.Button::configPrototype = c.initialConfig;
	}-*/;
	...
	public native boolean hasVisibleMenu() /*-{
		var button = this.@com.ait.toolkit.sencha.ext.client.core.Component::getJsObj()();
		if (button == null)
			return false;
	...
	public native void setBadgeText(String text) /*-{
		var button = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
		if (button.setBadgeText) {
	...
	public native void setTooltip(Tip tip) /*-{
		var button = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
		button
				.setTooltip(tip.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()());
	}-*/;
	...
	public native HandlerRegistration addClickHandler(ClickHandler handler)/*-{
		...
		var fn = function(b, e) {
			...
			var clickEvent = @com.ait.toolkit.sencha.ext.client.events.button.ClickEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/Button;Lcom/google/gwt/core/client/JavaScriptObject;)(button,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.button.ClickHandler::onClick(Lcom/ait/toolkit/sencha/ext/client/events/button/ClickEvent;)(clickEvent);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.button.ClickEvent::EVENT_NAME;
	...
	public native HandlerRegistration addIconChangeHandler(
		...
		var fn = function(b, oldIcon, newIcon, e) {
			var button = @com.ait.toolkit.sencha.ext.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
			var event = @com.ait.toolkit.sencha.ext.client.events.button.IconChangeEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/Button;Ljava/lang/String;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(button,oldIcon,newIcon, e);
			handler.@com.ait.toolkit.sencha.ext.client.events.button.IconChangeHandler::onIconChange(Lcom/ait/toolkit/sencha/ext/client/events/button/IconChangeEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.button.IconChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	...
	public native HandlerRegistration addGlyphChangeHandler(
		...
		var fn = function(b, oldG, newG, e) {
			var button = @com.ait.toolkit.sencha.ext.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
			var event = @com.ait.toolkit.sencha.ext.client.events.button.GlyphChangeEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/Button;Ljava/lang/String;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(button,oldG,newG, e);
			handler.@com.ait.toolkit.sencha.ext.client.events.button.GlyphChangeHandler::onGlyphChange(Lcom/ait/toolkit/sencha/ext/client/events/button/GlyphChangeEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.button.GlyphChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	...
	public native HandlerRegistration addMenuHideHandler(MenuHideHandler handler)/*-{
		...
		var fn = function(b, m, e) {
			...
			var event = @com.ait.toolkit.sencha.ext.client.events.button.MenuHideEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/Button;Lcom/ait/toolkit/sencha/ext/client/ui/Menu;Lcom/google/gwt/core/client/JavaScriptObject;)(button,menu,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.button.MenuHideHandler::onMenuHide(Lcom/ait/toolkit/sencha/ext/client/events/button/MenuHideEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.button.MenuHideEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addMenuShowHandler(MenuShowHandler handler)/*-{
		...
		var fn = function(b, m, e) {
			var button = @com.ait.toolkit.sencha.ext.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
			var menu = @com.ait.toolkit.sencha.ext.client.ui.Menu::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var event = @com.ait.toolkit.sencha.ext.client.events.button.MenuShowEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/Button;Lcom/ait/toolkit/sencha/ext/client/ui/Menu;Lcom/google/gwt/core/client/JavaScriptObject;)(button,menu,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.button.MenuShowHandler::onMenuShow(Lcom/ait/toolkit/sencha/ext/client/events/button/MenuShowEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.button.MenuShowEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addMenuTriggerOutHandler(
		...
		var fn = function(b, m, e) {
			var button = @com.ait.toolkit.sencha.ext.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
			var menu = @com.ait.toolkit.sencha.ext.client.ui.Menu::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var event = @com.ait.toolkit.sencha.ext.client.events.button.MenuTriggerOutEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/Button;Lcom/ait/toolkit/sencha/ext/client/ui/Menu;Lcom/google/gwt/core/client/JavaScriptObject;)(button,menu,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.button.MenuTriggerOutHandler::onMenuTriggerOut(Lcom/ait/toolkit/sencha/ext/client/events/button/MenuTriggerOutEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.button.MenuTriggerOutEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addMenuTriggerOverHandler(
		...
		var fn = function(b, m, e) {
			var button = @com.ait.toolkit.sencha.ext.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
			var menu = @com.ait.toolkit.sencha.ext.client.ui.Menu::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var event = @com.ait.toolkit.sencha.ext.client.events.button.MenuTriggerOverEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/Button;Lcom/ait/toolkit/sencha/ext/client/ui/Menu;Lcom/google/gwt/core/client/JavaScriptObject;)(button,menu,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.button.MenuTriggerOverHandler::onMenuTriggerOver(Lcom/ait/toolkit/sencha/ext/client/events/button/MenuTriggerOverEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.button.MenuTriggerOverEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addMouseOutHandler(MouseOutHandler handler)/*-{
		...
		var fn = function(b, e) {
			var button = @com.ait.toolkit.sencha.ext.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
			var event = @com.ait.toolkit.sencha.ext.client.events.button.MouseOutEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/Button;Lcom/google/gwt/core/client/JavaScriptObject;)(button,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.button.MouseOutHandler::onMouseOut(Lcom/ait/toolkit/sencha/ext/client/events/button/MouseOutEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.button.MouseOutEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	...
	public native HandlerRegistration addMouseOverHandler(
		...
		var fn = function(b, e) {
			var button = @com.ait.toolkit.sencha.ext.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
			var event = @com.ait.toolkit.sencha.ext.client.events.button.MouseOverEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/Button;Lcom/google/gwt/core/client/JavaScriptObject;)(button,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.button.MouseOverHandler::onMouseOver(Lcom/google/gwt/event/dom/client/MouseOverEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.button.MouseOverEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addTextChangeHandler(
		...
		var fn = function(b, ot, nt, e) {
			var button = @com.ait.toolkit.sencha.ext.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
			var event = @com.ait.toolkit.sencha.ext.client.events.button.TextChangeEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/Button;Ljava/lang/String;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(button,ot,nt,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.button.TextChangeHandler::onTextChange(Lcom/ait/toolkit/sencha/ext/client/events/button/TextChangeEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.button.TextChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addToggleHandler(ToggleHandler handler)/*-{
		...
		var fn = function(b, pressed, e) {
			var button = @com.ait.toolkit.sencha.ext.client.ui.Button::new(Lcom/google/gwt/core/client/JavaScriptObject;)(b);
			var event = @com.ait.toolkit.sencha.ext.client.events.button.ToggleEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/Button;ZLcom/google/gwt/core/client/JavaScriptObject;)(button,pressed, e);
			handler.@com.ait.toolkit.sencha.ext.client.events.button.ToggleHandler::onToggle(Lcom/ait/toolkit/sencha/ext/client/events/button/ToggleEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.button.ToggleEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
