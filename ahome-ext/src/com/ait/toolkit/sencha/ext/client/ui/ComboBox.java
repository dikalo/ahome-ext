...
public class ComboBox extends Picker {
	 ...
	 *             rendered
	 */
	public void setListAlign(String anchorPosition)
			throws IllegalStateException {
	...
	/**
	 * Set to {@link com.ait.toolkit.sencha.ext.client.ui.ComboBox#LOCAL} if the
	 * ComboBox loads local data. (defaults to
	 * {@link com.ait.toolkit.sencha.ext.client.ui.ComboBox#REMOTE} which loads
	 * from the server)
	 * 
	 * @param mode
	 ...
	 */
	public native HandlerRegistration addBeforeQueryHandler(
			com.ait.toolkit.sencha.ext.client.events.form.BeforeQueryHandler handler)/*-{
		var component = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
	 ...
	 */
	public native HandlerRegistration addSelectHandler(
			com.ait.toolkit.sencha.ext.client.events.form.SelectHandler handler)/*-{
		var component = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
