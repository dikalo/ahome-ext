...
import com.ait.toolkit.sencha.ext.client.core.ComponentTraversalCallback;
import com.ait.toolkit.sencha.ext.client.core.DefaultsHandler;
import com.ait.toolkit.sencha.ext.client.core.Ext;
import com.ait.toolkit.sencha.ext.client.core.WidgetComponent;
...
import com.ait.toolkit.sencha.ext.client.events.container.AddHandler;
import com.ait.toolkit.sencha.ext.client.events.container.AfterLayoutHandler;
import com.ait.toolkit.sencha.ext.client.events.container.BeforeAddHandler;
import com.ait.toolkit.sencha.ext.client.events.container.BeforeRemoveHandler;
import com.ait.toolkit.sencha.ext.client.events.container.ContainerBeforeRemoveHandler;
import com.ait.toolkit.sencha.ext.client.events.container.ContainerContentChangeHandler;
import com.ait.toolkit.sencha.ext.client.layout.AbsoluteLayout;
import com.ait.toolkit.sencha.ext.client.layout.AccordionLayout;
import com.ait.toolkit.sencha.ext.client.layout.AnchorLayout;
import com.ait.toolkit.sencha.ext.client.layout.AutoLayout;
import com.ait.toolkit.sencha.ext.client.layout.BorderLayout;
import com.ait.toolkit.sencha.ext.client.layout.BorderRegion;
import com.ait.toolkit.sencha.ext.client.layout.CardLayout;
import com.ait.toolkit.sencha.ext.client.layout.ColumnLayout;
import com.ait.toolkit.sencha.ext.client.layout.ContainerLayout;
import com.ait.toolkit.sencha.ext.client.layout.FitLayout;
import com.ait.toolkit.sencha.ext.client.layout.FormLayout;
import com.ait.toolkit.sencha.ext.client.layout.HBoxLayout;
import com.ait.toolkit.sencha.ext.client.layout.Layout;
import com.ait.toolkit.sencha.ext.client.layout.LayoutData;
import com.ait.toolkit.sencha.ext.client.layout.TableLayout;
...
public class Container extends Component implements HasWidgets {
	...
	private native void init()/*-{
		...
		@com.ait.toolkit.sencha.ext.client.ui.Container::configPrototype = c.initialConfig;
	}-*/;
	...
	public native void remove(Component component, boolean autoDestroy) /*-{
		var container = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
		var componentJS = component.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
	...
	public native Component[] findBy(ComponentTraversalCallback cb)/*-{
		...
		var comps = container
				.findBy(function(comp) {
					var compJ = @com.ait.toolkit.sencha.ext.client.ui.ComponentFactory::getComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(comp);
					return cb.@com.ait.toolkit.sencha.ext.client.core.ComponentTraversalCallback::execute(Lcom/ait/toolkit/sencha/ext/client/core/Component;)(compJ);
				});
		return @com.ait.toolkit.sencha.ext.client.core.Ext::convertToJavaComponentArray(Lcom/google/gwt/core/client/JavaScriptObject;)(comps);
	}-*/;
	...
	public native HandlerRegistration addAddHandler(AddHandler handler)/*-{
		...
		var fn = function(ct, cmp, index, e) {
			...
			var component = @com.ait.toolkit.sencha.ext.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(cmp);
			var event = @com.ait.toolkit.sencha.ext.client.events.container.AddEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/ait/toolkit/sencha/ext/client/ui/Container;ILcom/google/gwt/core/client/JavaScriptObject;)(container, component, index,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.container.AddHandler::onAdd(Lcom/ait/toolkit/sencha/ext/client/events/container/AddEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.container.AddEvent::EVENT_NAME;
	...
	public native HandlerRegistration addAfterLayoutHandler(
		...
		var fn = function(ct, l, e) {
			var container = @com.ait.toolkit.sencha.ext.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var layout = @com.ait.toolkit.sencha.ext.client.layout.ContainerLayout::new(Lcom/google/gwt/core/client/JavaScriptObject;)(l);
			var event = @com.ait.toolkit.sencha.ext.client.events.container.AfterLayoutEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/Container;Lcom/ait/toolkit/sencha/ext/client/layout/ContainerLayout;Lcom/google/gwt/core/client/JavaScriptObject;)(container, layout, e);
			handler.@com.ait.toolkit.sencha.ext.client.events.container.AfterLayoutHandler::onAfterLayout(Lcom/ait/toolkit/sencha/ext/client/events/container/AfterLayoutEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.container.AfterLayoutEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	...
	public native HandlerRegistration addBeforeAddHandler(
		...
		var fn = function(ct, cmp, index, e) {
			var container = @com.ait.toolkit.sencha.ext.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var component = @com.ait.toolkit.sencha.ext.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(cmp);
			var event = @com.ait.toolkit.sencha.ext.client.events.container.BeforeAddEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/ait/toolkit/sencha/ext/client/ui/Container;ILcom/google/gwt/core/client/JavaScriptObject;)(container, component, index,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.container.BeforeAddHandler::onBeforeAdd(Lcom/ait/toolkit/sencha/ext/client/events/container/BeforeAddEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.container.BeforeAddEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	...
	public native void addBeforeRemoveHandler(
		...
		if (component) {
			component
					.addListener(
							@com.ait.toolkit.sencha.ext.client.events.Event::BEFORE_REMOVE,
							$entry(function(ct, c) {
								var comp = @com.ait.toolkit.sencha.ext.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
								var container = @com.ait.toolkit.sencha.ext.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
								return handler.@com.ait.toolkit.sencha.ext.client.events.container.ContainerBeforeRemoveHandler::onEvent(Lcom/ait/toolkit/sencha/ext/client/ui/Container;Lcom/ait/toolkit/sencha/ext/client/core/Component;)(container,comp);
							}));
		}
	}-*/;
	...
	public native HandlerRegistration addBeforeRemoveHandler(
		...
		var fn = function(ct, cmp, e) {
			var container = @com.ait.toolkit.sencha.ext.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var component = @com.ait.toolkit.sencha.ext.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(cmp);
			var event = @com.ait.toolkit.sencha.ext.client.events.container.BeforeRemoveEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/ait/toolkit/sencha/ext/client/ui/Container;Lcom/google/gwt/core/client/JavaScriptObject;)(container,component,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.container.BeforeRemoveHandler::onBeforeRemove(Lcom/ait/toolkit/sencha/ext/client/events/container/BeforeRemoveEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.container.BeforeRemoveEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	...
	public native HandlerRegistration addRemoveHandler(
		...
		var fn = function(ct, cmp, e) {
			var container = @com.ait.toolkit.sencha.ext.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
			var component = @com.ait.toolkit.sencha.ext.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(cmp);
			var event = @com.ait.toolkit.sencha.ext.client.events.container.RemoveEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/ait/toolkit/sencha/ext/client/ui/Container;Lcom/google/gwt/core/client/JavaScriptObject;)(container,component,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.container.RemoveHandler::onRemove(Lcom/ait/toolkit/sencha/ext/client/events/container/RemoveEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.container.RemoveEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
			...
			component
					.addListener(
							...
							$entry(function(ct, c, index) {
								var comp = @com.ait.toolkit.sencha.ext.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
								var container = @com.ait.toolkit.sencha.ext.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
								handler.@com.ait.toolkit.sencha.ext.client.events.container.ContainerContentChangeHandler::onEvent(Lcom/ait/toolkit/sencha/ext/client/ui/Container;Lcom/ait/toolkit/sencha/ext/client/core/Component;I)(container,comp,index);
							}));
		}
