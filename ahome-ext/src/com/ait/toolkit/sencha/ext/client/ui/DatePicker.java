...
import com.ait.toolkit.sencha.ext.client.events.datepicker.SelectHandler;
...
/**
 * This class is used by the com.ait.toolkit.sencha.ext.client.form.field.Date field to
...
public class DatePicker extends Component {
    ...
    private native void init()/*-{
		...
		@com.ait.toolkit.sencha.ext.client.ui.DatePicker::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native DatePicker showNextYear() /*-{
		var datePicker = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
    ...
    public native HandlerRegistration addSelectHandler(SelectHandler handler)/*-{
		...
		var fn = function(cmp, date, e) {
			var datePicker = @com.ait.toolkit.sencha.ext.client.ui.DatePicker::new(Lcom/google/gwt/core/client/JavaScriptObject;)(cmp);
			var event = @com.ait.toolkit.sencha.ext.client.events.datepicker.SelectEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/DatePicker;Lcom/google/gwt/core/client/JsDate;Lcom/google/gwt/core/client/JavaScriptObject;)(datePicker, date, e);
			handler.@com.ait.toolkit.sencha.ext.client.events.datepicker.SelectHandler::onSelect(Lcom/ait/toolkit/sencha/ext/client/events/datepicker/SelectEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.datepicker.SelectEvent::EVENT_NAME;
