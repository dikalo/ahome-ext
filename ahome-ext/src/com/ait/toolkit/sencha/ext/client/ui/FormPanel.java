...
import com.ait.toolkit.sencha.ext.client.tip.QuickTips;
...
public class FormPanel extends Panel {
	...
	private static native void doInit()/*-{
		...
		@com.ait.toolkit.sencha.ext.client.ui.FormPanel::configPrototype = c.initialConfig;
	}-*/;
	...
	public native void startMonitoring() /*-{
		var formPanel = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
	 ...
	 * {@link #addFormListener(com.ait.toolkit.sencha.ext.client.ui.form.event.FormListener)}
	 * instead.
	 * 
	...
	public native Form getForm() /*-{
		...
		return @com.ait.toolkit.sencha.ext.client.ui.Form::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(formJS);
	}-*/;
	 ...
	 * {@link com.ait.toolkit.sencha.ext.client.ui.MessageBox#wait(long)}. You
	 * can target a specific element by passing its id.
	 * 
	 * @param waitMsgTarget
	 ...
	 * By default wait messages are displayed with
	 * {@link com.ait.toolkit.sencha.ext.client.ui.MessageBox#wait(long)}. You
	 * can mask the form itself by passing in true.
	 * 
	 * @param waitMsgTarget
