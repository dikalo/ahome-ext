...
public class Image extends Component {
    ...
    private native void init()/*-{
		...
		@com.ait.toolkit.sencha.ext.client.ui.Image::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native void setSrc(String value) /*-{
		var image = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
		image.setSrc(value);
    }-*/;
