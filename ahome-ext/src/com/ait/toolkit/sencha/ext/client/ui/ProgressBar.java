...
import com.ait.toolkit.sencha.ext.client.core.config.WaitConfig;
...
public class ProgressBar extends Component {
    ...
    private native void init()/*-{
		...
		@com.ait.toolkit.sencha.ext.client.ui.ProgressBar::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native boolean isWaiting() /*-{
		var progressBar = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
     ...
     */
    public native HandlerRegistration addUpdateHandler(com.ait.toolkit.sencha.ext.client.events.progressbar.UpdateHandler handler)/*-{
		var component = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
		var fn = function(p, value, text, e) {
			var pgr = @com.ait.toolkit.sencha.ext.client.ui.ProgressBar::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
			var event = @com.ait.toolkit.sencha.ext.client.events.progressbar.UpdateEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/ProgressBar;DLjava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(pgr,value,text,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.progressbar.UpdateHandler::onUpdate(Lcom/ait/toolkit/sencha/ext/client/events/progressbar/UpdateEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.progressbar.UpdateEvent::EVENT_NAME;
