...
import com.ait.toolkit.sencha.ext.client.events.tab.BeforeTabChangeHandler;
import com.ait.toolkit.sencha.ext.client.events.tab.TabPanelBeforeTabChangeHandler;
import com.ait.toolkit.sencha.ext.client.tab.TabBar;
...
public class TabPanel extends Panel {
	...
	private native void init()/*-{
		...
		@com.ait.toolkit.sencha.ext.client.ui.TabPanel::configPrototype = c.initialConfig;
	}-*/;
	...
	public native TabBar getTabBar() /*-{
		var tabPanel = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
		var tab = tabPanel.getTabBar();
		if (!tab) {
			return null;
		}
		return @com.ait.toolkit.sencha.ext.client.tab.TabBar::new(Lcom/google/gwt/core/client/JavaScriptObject;)(tab);
	...
	public native void addBeforeTabChangeHandler(TabPanelBeforeTabChangeHandler handler)/*-{
		...
		if (component) {
			component
					.addListener(
							@com.ait.toolkit.sencha.ext.client.events.Event::TAB_CHANGE,
							$entry(function(p, newCard, oldCard) {
								var oldComp = null;
								var tabPanel = @com.ait.toolkit.sencha.ext.client.ui.TabPanel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
								var newComp = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(newCard);
								if (oldCard) {
									oldComp = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(oldCard);
								}
								return handler.@com.ait.toolkit.sencha.ext.client.events.tab.TabPanelBeforeTabChangeHandler::onEvent(Lcom/ait/toolkit/sencha/ext/client/ui/TabPanel;Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/ait/toolkit/sencha/ext/client/core/Component;)(tabPanel,newComp,oldComp);
							}));
		}
	...
	public native HandlerRegistration addBeforeTabChangeHandler(BeforeTabChangeHandler handler)/*-{
		...
		var fn = function(tp, oc, nc, e) {
			...
			var oldCard = @com.ait.toolkit.sencha.ext.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(oc);
			var newCard = @com.ait.toolkit.sencha.ext.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(nc);
			var event = @com.ait.toolkit.sencha.ext.client.events.tab.BeforeTabChangeEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/TabPanel;Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(panel,oldCard,newCard,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.tab.BeforeTabChangeHandler::onBeforeTabChange(Lcom/ait/toolkit/sencha/ext/client/events/tab/BeforeTabChangeEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.tab.BeforeTabChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
