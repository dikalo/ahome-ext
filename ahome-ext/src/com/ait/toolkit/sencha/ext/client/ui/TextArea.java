...
public class TextArea extends TextField {
	...
	private static native void init()/*-{
		...
		@com.ait.toolkit.sencha.ext.client.ui.TextArea::configPrototype = c.initialConfig;
	}-*/;
	...
	/**
	 * An initial value for the 'cols' attribute on the textarea element. This is only used if the component has no configured width and is not given a width by its container's
	 * layout.
	 * <p>
	 * Defaults to: 20
	 */
	...
	/**
	 * An initial value for the 'rows' attribute on the textarea element. This is only used if the component has no configured height and is not given a height by its container's
