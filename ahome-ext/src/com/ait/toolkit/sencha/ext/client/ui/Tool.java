...
import com.ait.toolkit.sencha.ext.client.events.panel.ToolClickHandler;
import com.ait.toolkit.sencha.ext.client.events.panel.ToolHandler;
import com.ait.toolkit.sencha.ext.client.tip.Tip;
import com.google.gwt.core.client.JavaScriptObject;

/**
 * This class is used to display small visual icons in the header of a panel. There are a set of 25 icons that can be specified by using the type config. The handler config can be
 * used to provide a function that will respond to any click events. In general, this class will not be instantiated directly, rather it will be created by specifying the
 * Ext.panel.Panel.tools configuration on the NotificationContainer itself.
 * 
 */
public class Tool extends Component {
	...
	public native HandlerRegistration addToolClickHandler(ToolClickHandler handler)/*-{
		...
		var eventName = @com.ait.toolkit.sencha.ext.client.events.panel.ToolClickEvent::EVENT_NAME;
	...
	static List<Tool> fromJsArray(JavaScriptObject peers) {
