...
public class Viewport extends Container implements AcceptsOneWidget {
	...
	public static Viewport get(String layout) {
		if (viewPort == null) {
			viewPort = initViewPort(layout, 0);
		}
		return viewPort;
	}
	...
	public static Viewport cast(Component component) {
		return new Viewport(component.getOrCreateJsObj());
	}
	...
	public native void attach() /*-{
		@com.ait.toolkit.sencha.ext.client.ui.Viewport::viewPort.@com.google.gwt.user.client.ui.Widget::onAttach()();
	}-*/;
