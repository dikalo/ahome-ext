...
import com.ait.toolkit.sencha.ext.client.core.config.ComponentConfig;
...
import com.ait.toolkit.sencha.ext.client.events.component.ActivateHandler;
import com.ait.toolkit.sencha.ext.client.events.component.AfterRenderHandler;
import com.ait.toolkit.sencha.ext.client.events.component.BeforeActivateHandler;
import com.ait.toolkit.sencha.ext.client.events.component.BeforeDeactivateHandler;
import com.ait.toolkit.sencha.ext.client.events.component.BeforeDestroyHandler;
import com.ait.toolkit.sencha.ext.client.events.component.BeforeHideHandler;
import com.ait.toolkit.sencha.ext.client.events.component.BeforeRenderHandler;
import com.ait.toolkit.sencha.ext.client.events.component.BeforeShowHandler;
import com.ait.toolkit.sencha.ext.client.events.component.BeforeStateRestoreHandler;
import com.ait.toolkit.sencha.ext.client.events.component.BeforeStateSaveHandler;
import com.ait.toolkit.sencha.ext.client.events.component.BlurHandler;
import com.ait.toolkit.sencha.ext.client.events.component.DeactivateHandler;
import com.ait.toolkit.sencha.ext.client.events.component.DestroyHandler;
import com.ait.toolkit.sencha.ext.client.events.component.DisableHandler;
import com.ait.toolkit.sencha.ext.client.events.component.EnableHandler;
import com.ait.toolkit.sencha.ext.client.events.component.EventHandler;
import com.ait.toolkit.sencha.ext.client.events.component.FocusHandler;
import com.ait.toolkit.sencha.ext.client.events.component.HideHandler;
import com.ait.toolkit.sencha.ext.client.events.component.LifeCycleHandler;
import com.ait.toolkit.sencha.ext.client.events.component.MoveHandler;
import com.ait.toolkit.sencha.ext.client.events.component.RemovedHandler;
import com.ait.toolkit.sencha.ext.client.events.component.RenderHandler;
import com.ait.toolkit.sencha.ext.client.events.component.ResizeHandler;
import com.ait.toolkit.sencha.ext.client.events.component.ShowHandler;
import com.ait.toolkit.sencha.ext.client.events.component.StateRestoreHandler;
import com.ait.toolkit.sencha.ext.client.events.component.StateSaveHandler;
import com.ait.toolkit.sencha.ext.client.events.component.VisualStateChangeHandler;
...
import com.ait.toolkit.sencha.ext.client.ui.LoadMask;
...
import com.ait.toolkit.sencha.shared.client.core.Position;
...
import com.ait.toolkit.sencha.shared.client.util.Region;
...
public abstract class Component extends AbstractComponent implements Observable, IsComponentElement {
    ...
    public native void relayEvents( Component observable, JsArrayString events ) /*-{
		...
		component
				.relayEvents(
						observable.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()(),
						events);
    }-*/;
    ...
    public native void relayEvents( JsObject observable, JsArrayString events ) /*-{
		...
		component.relayEvents(
				observable.@com.ait.toolkit.core.client.JsObject::getJsObj()(),
				events);
    }-*/;
    ...
    public native Container getOwnerContainer() /*-{
		...
		return ct == null || ct === undefined
				? null
				: @com.ait.toolkit.sencha.ext.client.ui.Container::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(ct);
    }-*/;
    ...
    public native boolean isRendered() /*-{
		var component = this.@com.ait.toolkit.sencha.ext.client.core.Component::getJsObj()();
    ...
    public native Container findParentBy( ContainerTraversalCallback cb )/*-{
		...
		var container = component
				.findParentBy(function(container) {
					var containerJ = @com.ait.toolkit.sencha.ext.client.ui.ComponentFactory::getComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(container);
					return cb.@com.ait.toolkit.sencha.ext.client.core.ContainerTraversalCallback::execute(Lcom/ait/toolkit/sencha/ext/client/ui/Container;)(containerJ);
				});
		return container == null || container === undefined
				? null
				: @com.ait.toolkit.sencha.ext.client.ui.ComponentFactory::getComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(container);
    }-*/;
    ...
    public native void hide( ExtElement animateTarget ) /*-{
		var component = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
		component.hide(animateTarget
				.@com.ait.toolkit.core.client.JsObject::getJsObj());
    }-*/;
    ...
    public native void hide( Component animateTarget ) /*-{
		...
		component
				.hide(animateTarget
						.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj());
    }-*/;
    ...
    public native ComponentPosition getLocalXY()/*-{
		...
		return @com.ait.toolkit.sencha.ext.client.core.ComponentPosition::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native void setPosition( double left, double right, Animation animation ) /*-{
		...
		component
				.setPosition(
						left,
						right,
						animation.@com.ait.toolkit.sencha.shared.client.fx.Animation::getJsObj()());
    }-*/;
     ...
     * @param cls
     *            the CSS class
     * @see com.ait.toolkit.sencha.ext.client.core.Component#setCls(String)
     */
     ...
     * @param cls
     *            the CSS class
     * @see com.ait.toolkit.sencha.ext.client.core.Component#addCls(String)
     */
     ...
     * @param cls
     *            the CSS class
     * @see com.ait.toolkit.sencha.ext.client.core.Component#removeCls(String)
     */
    ...
    public int getOffsetHeight() {
        return getElement( false ).getPropertyInt( "offsetHeight" );
    }

    public int getOffsetWidth() {
        return getElement( false ).getPropertyInt( "offsetWidth" );
    }

    public String getTitle() {
        return getElement( false ).getPropertyString( "title" );
    }
    ...
    public native LoadMask setLoading( String message ) /*-{
		...
		return @com.ait.toolkit.sencha.ext.client.ui.LoadMask::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    /**
     * Sets the draggable property of this panel
     * 
     * @param config
    ...
    public static native void disableShadow( ExtElement el )/*-{
		var element = el.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		...
		if (component) {
			component
					.addListener(
							event,
							$entry(function(c) {
								var comp = @com.ait.toolkit.sencha.ext.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
								handler.@com.ait.toolkit.sencha.ext.client.events.component.EventHandler::onEvent(Lcom/ait/toolkit/sencha/ext/client/core/Component;)(comp);
							}));
		}
		...
		if (component) {
			component
					.addListener(
							...
							$entry(function(c) {
								var comp = @com.ait.toolkit.sencha.ext.client.core.SimpleComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
								return handler.@com.ait.toolkit.sencha.ext.client.events.component.LifeCycleHandler::onEvent(Lcom/ait/toolkit/sencha/ext/client/core/Component;)(comp);
							}));
		}
			...
			component
					.addListener(
							...
							$entry(function(c, e) {
								...
								handler.@com.ait.toolkit.sencha.ext.client.events.component.VisualStateChangeHandler::onEvent(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/ait/toolkit/sencha/shared/client/core/EventObject;)(comp,eventObject);
							}));
		}
    ...
    public native HandlerRegistration addActivateHandler( ActivateHandler handler )/*-{
		...
		var fn = function(c, e) {
			...
			var activateEvent = @com.ait.toolkit.sencha.ext.client.events.component.ActivateEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e)
			handler.@com.ait.toolkit.sencha.ext.client.events.component.ActivateHandler::onActivate(Lcom/ait/toolkit/sencha/ext/client/events/component/ActivateEvent;)(activateEvent);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.ActivateEvent::EVENT_NAME;
    ...
    public native HandlerRegistration addAddedHandler( com.ait.toolkit.sencha.ext.client.events.component.AddedHandler handler )/*-{
		...
		var fn = function(c, cont, pos, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var container = @com.ait.toolkit.sencha.ext.client.ui.Container::new(Lcom/google/gwt/core/client/JavaScriptObject;)(cont);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.AddedEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/ait/toolkit/sencha/ext/client/ui/Container;ILcom/google/gwt/core/client/JavaScriptObject;)(component,container,pos,event);
			handler.@com.ait.toolkit.sencha.ext.client.events.component.AddedHandler::onAdded(Lcom/ait/toolkit/sencha/ext/client/events/component/AddedEvent;)(addedEvent);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.AddedEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    ...
    public native HandlerRegistration addAfterRenderHandler( AfterRenderHandler handler )/*-{
		...
		var fn = function(c, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.AfterRenderEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.component.AfterRenderHandler::onAfterRender(Lcom/ait/toolkit/sencha/ext/client/events/component/AfterRenderEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.AfterRenderEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeActivateHandler( BeforeActivateHandler handler )/*-{
		...
		var fn = function(c, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.BeforeActivateEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.component.BeforeActivateHandler::onBeforeActivate(Lcom/ait/toolkit/sencha/ext/client/events/component/BeforeActivateEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.BeforeActivateEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeDeactivateHandler( BeforeDeactivateHandler handler )/*-{
		...
		var fn = function(c, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.BeforeDeactivateEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.component.BeforeDeactivateHandler::onBeforeDeactivate(Lcom/ait/toolkit/sencha/ext/client/events/component/BeforeDeactivateEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.BeforeDeactivateEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeDestroyHandler( BeforeDestroyHandler handler )/*-{
		...
		var fn = function(c, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.BeforeDestroyEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.component.BeforeDestroyHandler::onBeforeDestroy(Lcom/ait/toolkit/sencha/ext/client/events/component/BeforeDestroyEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.BeforeDestroyEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeHideHandler( BeforeHideHandler handler )/*-{
		...
		var fn = function(c, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.BeforeHideEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.component.BeforeHideHandler::onBeforeHide(Lcom/ait/toolkit/sencha/ext/client/events/component/BeforeHideEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.BeforeHideEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeRenderHandler( BeforeRenderHandler handler )/*-{
		...
		var fn = function(c, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.BeforeRenderEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.component.BeforeRenderHandler::onBeforeRender(Lcom/ait/toolkit/sencha/ext/client/events/component/BeforeRenderEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.BeforeRenderEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeShowHandler( BeforeShowHandler handler )/*-{
		...
		var fn = function(c, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.BeforeShowEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.component.BeforeShowHandler::onBeforeShow(Lcom/ait/toolkit/sencha/ext/client/events/component/BeforeShowEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.BeforeShowEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeStateRestoreHandler( BeforeStateRestoreHandler handler )/*-{
		...
		var fn = function(c, st, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var state = @com.ait.toolkit.sencha.ext.client.core.State::new(Lcom/google/gwt/core/client/JavaScriptObject;)(st);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.BeforeStateRestoreEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/ait/toolkit/sencha/ext/client/core/State;Lcom/google/gwt/core/client/JavaScriptObject;)(component,container,pos,event);
			handler.@com.ait.toolkit.sencha.ext.client.events.component.BeforeStateRestoreHandler::onBeforeStateRestore(Lcom/ait/toolkit/sencha/ext/client/events/component/BeforeStateRestoreEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.BeforeStateRestoreEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBeforeStateSaveHandler( BeforeStateSaveHandler handler )/*-{
		...
		var fn = function(c, st, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var state = @com.ait.toolkit.sencha.ext.client.core.State::new(Lcom/google/gwt/core/client/JavaScriptObject;)(st);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.BeforeStateSaveEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/ait/toolkit/sencha/ext/client/core/State;Lcom/google/gwt/core/client/JavaScriptObject;)(event,state,e)
			handler.@com.ait.toolkit.sencha.ext.client.events.component.BeforeStateSaveHandler::onBeforeStateSave(Lcom/ait/toolkit/sencha/ext/client/events/component/BeforeStateSaveEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.BeforeStateSaveEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBlurHandler( BlurHandler handler )/*-{
		...
		var fn = function(c, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.BlurEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.component.BlurHandler::onBlur(Lcom/ait/toolkit/sencha/ext/client/events/component/BlurEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.BlurEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addBoxReadyHandler( com.ait.toolkit.sencha.ext.client.events.component.BoxReadyHandler handler )/*-{
		...
		var fn = function(c, w, h, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.BoxReadyEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;DDLcom/google/gwt/core/client/JavaScriptObject;)(component,h,w,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.component.BoxReadyHandler::onBoxReady(Lcom/ait/toolkit/sencha/ext/client/events/component/BoxReadyEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.BoxReadyEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addDeactivateHandler( DeactivateHandler handler )/*-{
		...
		var fn = function(c, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.DeactivateEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e)
			handler.@com.ait.toolkit.sencha.ext.client.events.component.DeactivateHandler::onDeactivate(Lcom/ait/toolkit/sencha/ext/client/events/component/DeactivateEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.DeactivateEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    ...
    public native HandlerRegistration addDestroyHandler( DestroyHandler handler )/*-{
		...
		var fn = function(c, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.DestroyEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e)
			handler.@com.ait.toolkit.sencha.ext.client.events.component.DestroyHandler::onDestroy(Lcom/ait/toolkit/sencha/ext/client/events/component/DestroyEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.DestroyEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    ...
    public native HandlerRegistration addDisableHandler( DisableHandler handler )/*-{
		...
		var fn = function(c, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.DisableEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e)
			handler.@com.ait.toolkit.sencha.ext.client.events.component.DisableHandler::onDisable(Lcom/ait/toolkit/sencha/ext/client/events/component/DisableEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.DisableEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    ...
    public native HandlerRegistration addEnableHandler( EnableHandler handler )/*-{
		...
		var fn = function(c, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.EnableEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e)
			handler.@com.ait.toolkit.sencha.ext.client.events.component.EnableHandler::onEnable(Lcom/ait/toolkit/sencha/ext/client/events/component/EnableEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.EnableEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    ...
    public native HandlerRegistration addFocusHandler( FocusHandler handler )/*-{
		...
		var fn = function(c, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.FocusEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e)
			handler.@com.ait.toolkit.sencha.ext.client.events.component.FocusHandler::onFocus(Lcom/ait/toolkit/sencha/ext/client/events/component/FocusEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.FocusEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    ...
    public native HandlerRegistration addHideHandler( HideHandler handler )/*-{
		...
		var fn = function(c, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.HideEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e)
			handler.@com.ait.toolkit.sencha.ext.client.events.component.HideHandler::onHide(Lcom/ait/toolkit/sencha/ext/client/events/component/HideEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.HideEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    ...
    public native HandlerRegistration addMoveHandler( MoveHandler handler )/*-{
		...
		var fn = function(c, x, y, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.MoveEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;DDLcom/google/gwt/core/client/JavaScriptObject;)(component,x,y,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.component.MoveHandler::onMove(Lcom/ait/toolkit/sencha/ext/client/events/component/MoveEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.MoveEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    ...
    public native HandlerRegistration addRemovedHandler( RemovedHandler handler )/*-{
		...
		var fn = function(c, ct, e) {
			...
			var event = @com.ait.toolkit.sencha.ext.client.events.component.RemovedEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/ait/toolkit/sencha/ext/client/ui/Container;Lcom/google/gwt/core/client/JavaScriptObject;)(compoent,container,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.component.RemovedHandler::onRemoved(Lcom/ait/toolkit/sencha/ext/client/events/component/RemovedEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.RemovedEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addRenderHandler( RenderHandler handler )/*-{
		...
		var fn = function(c, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.RenderEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.component.RenderHandler::onRender(Lcom/ait/toolkit/sencha/ext/client/events/component/RenderEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.RenderEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addShowHandler( ShowHandler handler )/*-{
		...
		var fn = function(c, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.ShowEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.component.ShowHandler::onShow(Lcom/ait/toolkit/sencha/ext/client/events/component/ShowEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.ShowEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addResizeHandler( ResizeHandler handler )/*-{
		...
		var fn = function(c, w, h, ow, oh, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.ResizeEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;DDDDLcom/google/gwt/core/client/JavaScriptObject;)(component,w,h,ow,oh,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.component.ResizeHandler::onResize(Lcom/ait/toolkit/sencha/ext/client/events/component/ResizeEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.ResizeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addStateRestoreHandler( StateRestoreHandler handler )/*-{
		...
		var fn = function(c, st, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var state = @com.ait.toolkit.sencha.ext.client.core.State::new(Lcom/google/gwt/core/client/JavaScriptObject;)(st);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.StateRestoreEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/ait/toolkit/sencha/ext/client/core/State;Lcom/google/gwt/core/client/JavaScriptObject;)(event,state,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.component.StateRestoreHandler::onStateRestore(Lcom/ait/toolkit/sencha/ext/client/events/component/StateRestoreEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.StateRestoreEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addStateSaveHandler( StateSaveHandler handler )/*-{
		...
		var fn = function(c, st, e) {
			var component = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var state = @com.ait.toolkit.sencha.ext.client.core.State::new(Lcom/google/gwt/core/client/JavaScriptObject;)(st);
			var event = @com.ait.toolkit.sencha.ext.client.events.component.StateSaveEvent::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/ait/toolkit/sencha/ext/client/core/State;Lcom/google/gwt/core/client/JavaScriptObject;)(event,state,e)
			handler.@com.ait.toolkit.sencha.ext.client.events.component.StateSaveHandler::onStateSave(Lcom/ait/toolkit/sencha/ext/client/events/component/StateSaveEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.component.StateSaveEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
