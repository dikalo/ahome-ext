...
public class WidgetComponent extends BoxComponent {
	...
	private native void init()/*-{
		var widget = this.@com.ait.toolkit.sencha.ext.client.core.WidgetComponent::w;
		var divID = this.@com.ait.toolkit.sencha.ext.client.core.WidgetComponent::componentId;
		$wnd.Ext
				.define(
						'Ext.ux.WidgetComponent',
						{
							...
							listeners : {
								...
								afterRender : function(component) {
									//var widget = @com.ait.toolkit.sencha.ext.client.core.WidgetComponent::get()();
									//alert(this.widget);
	...
	public WidgetComponent(Widget widget) {
		...
		addListener("beforedestroy", new Function() {
			public void execute() {
				Widget widget = (Widget) JsoHelper.getAttributeAsObject(config,
						"widget");
	...
	public native void _setWidget(Widget w)/*-{
		var jso = this.@com.ait.toolkit.sencha.ext.client.core.WidgetComponent::getOrCreateJsObj()();
		var id = jso.id;
	}-*/;
