...
/**
 * {@link com.ait.toolkit.sencha.ext.client.ui.MessageBox} configuration class.
 * 
 * @see com.ait.toolkit.sencha.ext.client.ui.MessageBox#show(MessageBoxConfig)
 */
public class MessageBoxConfig extends BaseConfig {
	...
	public native void setCallback(ConfirmCallback callback)/*-{
		...
		jso.fn = function(btn) {
			callback.@com.ait.toolkit.sencha.ext.client.events.messagebox.ConfirmCallback::execute(Ljava/lang/String;)(btn);
		}
	}-*/;
	...
	public native void setButtonText(ButtonText value)/*-{
		var jso = this.@com.ait.toolkit.sencha.ext.client.core.config.BaseConfig::getJsObj()();
		jso.buttonText = value.@com.ait.toolkit.sencha.ext.client.core.config.ButtonText::getJsObj()();
	}-*/;
