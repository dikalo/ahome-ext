...
import com.ait.toolkit.sencha.ext.client.core.config.SpriteConfig;
import com.ait.toolkit.sencha.ext.client.dd.DragSource;
...
public class Sprite extends JsObject {
    ...
    public native DragSource getDragSource()/*-{
		...
		var dd = jso.dd;
		return @com.ait.toolkit.sencha.ext.client.dd.DragSource::new(Lcom/google/gwt/core/client/JavaScriptObject;)(dd);
    }-*/;
