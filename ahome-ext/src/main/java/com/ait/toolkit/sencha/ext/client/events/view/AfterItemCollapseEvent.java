...
public class AfterItemCollapseEvent extends EventObject {
	 ...
	 */
	private static Type<AfterItemCollapseHandler> TYPE = new Type<AfterItemCollapseHandler>(
			EVENT_NAME, null);
	...
	public AfterItemCollapseEvent(NodeInterface node, int index,
			Element htmlElement, JavaScriptObject nativeEvent) {
		super(nativeEvent);
		this.node = node;
		this.index = index;
