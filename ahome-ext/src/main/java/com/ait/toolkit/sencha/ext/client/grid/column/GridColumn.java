...
public class GridColumn extends BaseConfig {
	...
	public void setRenderer(GridColumnRenderer renderer) {
		JsoHelper
				.setAttribute(getJsObj(), "renderer", createRenderer(renderer));
	}

	public void setSummaryRenderer(GridColumnSummaryRenderer renderer) {
		JsoHelper.setAttribute(getJsObj(), "summaryRenderer",
				createSummaryRenderer(renderer));
	}
	...
	private native JavaScriptObject createRenderer(GridColumnRenderer renderer)/*-{
		return function(value, metaData, rec, rowIndex, colIndex, store, view) {
			...
			var cellMetaData = @com.ait.toolkit.sencha.ext.client.grid.column.CellMetaData::new(Lcom/google/gwt/core/client/JavaScriptObject;)(metaData);
			var model = @com.ait.toolkit.data.client.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(rec);
			var s = @com.ait.toolkit.sencha.shared.client.data.Store::new(Lcom/google/gwt/core/client/JavaScriptObject;)(store);
			var dataView = @com.ait.toolkit.sencha.ext.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(view);
			return renderer.@com.ait.toolkit.sencha.ext.client.grid.column.GridColumnRenderer::onRender(Ljava/lang/String;Lcom/ait/toolkit/sencha/ext/client/grid/column/CellMetaData;Lcom/ait/toolkit/data/client/BaseModel;IILcom/ait/toolkit/sencha/shared/client/data/Store;Lcom/ait/toolkit/sencha/ext/client/ui/DataView;)(valueToProcess,cellMetaData,model,rowIndex,colIndex,s,dataView);
		};
	}-*/;

	private native JavaScriptObject createSummaryRenderer(
			GridColumnSummaryRenderer renderer)/*-{
		return function(value, data, field) {
			...
			return renderer.@com.ait.toolkit.sencha.ext.client.grid.column.GridColumnSummaryRenderer::onRender(Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;)(valueToProcess, data, field);
		};
	}-*/;
