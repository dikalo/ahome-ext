...
import com.ait.toolkit.sencha.ext.client.events.grid.GroupExpandHandler;
import com.ait.toolkit.sencha.ext.client.events.grid.GroupInteractionHandler;
...
public class Grouping extends Feature {
	...
	public native void collapse(ExtElement group)/*-{
		var jso = this.@com.ait.toolkit.core.client.JsObject::jsObj;
		jso.collapse(group.@com.ait.toolkit.core.client.JsObject::getJsObj()());
	}-*/;
	...
	public native void expand(ExtElement group)/*-{
		var jso = this.@com.ait.toolkit.core.client.JsObject::jsObj;
		jso.expand(group.@com.ait.toolkit.core.client.JsObject::getJsObj()());
	}-*/;
	...
	public native void addExpandHandler(GroupExpandHandler handler)/*-{
		var component = this.@com.ait.toolkit.core.client.JsObject::jsObj;
		if (component) {
			component
					.addListener(
							@com.ait.toolkit.sencha.ext.client.events.Event::GROUP_EXPAND,
							$entry(function(v, node, group) {
								...
								handler.@com.ait.toolkit.sencha.ext.client.events.grid.GroupExpandHandler::onEvent(Lcom/ait/toolkit/sencha/ext/client/ui/DataView;Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;)(view,node,group);
							}));
		}

	}-*/;

	private native void _addHandler(String event,
			GroupInteractionHandler handler)/*-{
		var component = this.@com.ait.toolkit.core.client.JsObject::jsObj;
		if (component) {
			component
					.addListener(
							...
							$entry(function(v, node, group, e) {
								...
								handler.@com.ait.toolkit.sencha.ext.client.events.grid.GroupInteractionHandler::onEvent(Lcom/ait/toolkit/sencha/ext/client/ui/DataView;Lcom/google/gwt/core/client/JavaScriptObject;Ljava/lang/String;Lcom/ait/toolkit/sencha/shared/client/core/EventObject;)(view,node,group,event);
							}));
		}
