...
public class AnchorLayout extends ContainerLayout {
    ...
    protected native JavaScriptObject create(JavaScriptObject config) /*-{
		...
		return this.@com.ait.toolkit.sencha.ext.client.layout.ContainerLayout::jsObj;
    }-*/;

    public native JavaScriptObject getContainerAttributes() /*-{
		if (this.@com.ait.toolkit.sencha.ext.client.layout.AnchorLayout::width != -1) {
			return {
				anchorSize : {
					width : this.@com.ait.toolkit.sencha.ext.client.layout.AnchorLayout::width,
					height : this.@com.ait.toolkit.sencha.ext.client.layout.AnchorLayout::height
				}
			};
		} else {
			return {};
