...
public class Tab extends Button {
    ...
    public native void setCard(Component card) /*-{
		var tab = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
		tab
				.setCard(card.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()());
    }-*/;
