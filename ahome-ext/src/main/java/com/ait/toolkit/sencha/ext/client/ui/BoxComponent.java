...
import com.ait.toolkit.sencha.ext.client.core.Box;
...
public class BoxComponent extends Component {
	...
	private native void init()/*-{
		...
		@com.ait.toolkit.sencha.ext.client.ui.BoxComponent::configPrototype = c.initialConfig;
	}-*/;
	...
	public native Box getBox()/*-{
		...
		return @com.ait.toolkit.sencha.ext.client.core.Box::instance(Lcom/google/gwt/core/client/JavaScriptObject;)(boxJS);
	}-*/;
	...
	public native void updateBox(Box box)/*-{
		var component = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
		var boxJS = box.@com.ait.toolkit.core.client.JsObject::getJsObj()();
