...
import com.ait.toolkit.sencha.ext.client.chart.Legend;
import com.ait.toolkit.sencha.ext.client.chart.axis.AbstractAxis;
import com.ait.toolkit.sencha.ext.client.chart.laf.Gradient;
import com.ait.toolkit.sencha.ext.client.chart.saving.ImageExport;
import com.ait.toolkit.sencha.ext.client.chart.series.AbstractSerie;
import com.ait.toolkit.sencha.ext.client.chart.theme.Theme;
...
import com.ait.toolkit.sencha.ext.client.events.chart.BeforeRefreshHandler;
import com.ait.toolkit.sencha.ext.client.events.chart.ChartEventHandler;
import com.ait.toolkit.sencha.ext.client.events.chart.RefreshHandler;
...
public class Chart extends DrawComponent {
	...
	private native void init()/*-{
		...
		@com.ait.toolkit.sencha.ext.client.ui.Chart::configPrototype = c.initialConfig;
	}-*/;
	...
	public static Chart newInstance(final Store store,
			final List<AbstractAxis> axis) {
		assert store != null;
		assert !axis.isEmpty();
	...
	public static Chart create(final Store store,
			final List<AbstractSerie> series) {
		assert store != null;
	...
	public static Chart newInstance(final Store store,
			final List<AbstractAxis> axis, final List<AbstractSerie> series) {
		assert store != null;
		assert !axis.isEmpty();
		assert !series.isEmpty();
		return new Chart() {
	...
	private List<AbstractSerie> _getSeriesNativePeers() {
		...
		if (nativePeers != null) {
			int size = JsoHelper.getArrayLength(nativePeers);
			for (int i = 0; i < size; i++) {
				AbstractSerie serie = AbstractSerie.create(JsoHelper
						.getValueFromJavaScriptObjectArray(nativePeers, i));
				toReturn.add(serie);
			}
		}
	...
	public native void refresh() /*-{
		var chart = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
		chart.refresh();
	}-*/;
	 ...
	 */
	public native HandlerRegistration addBeforeReshHandler(
			BeforeRefreshHandler handler)/*-{
		var component = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
		var fn = function(c, e) {
			var chart = @com.ait.toolkit.sencha.ext.client.ui.Chart::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.chart.BeforeRefreshEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/Chart;Lcom/google/gwt/core/client/JavaScriptObject;)(chart, event);
			handler.@com.ait.toolkit.sencha.ext.client.events.chart.BeforeRefreshHandler::onBeforeRefresh(Lcom/ait/toolkit/sencha/ext/client/events/chart/BeforeRefreshEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.chart.BeforeRefreshEvent::EVENT_NAME;
	...
	public native HandlerRegistration addReshHandler(RefreshHandler handler)/*-{
		...
		var fn = function(c, e) {
			var chart = @com.ait.toolkit.sencha.ext.client.ui.Chart::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.chart.RefreshEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/Chart;Lcom/google/gwt/core/client/JavaScriptObject;)(chart, event);
			handler.@com.ait.toolkit.sencha.ext.client.events.chart.RefreshHandler::onRefresh(Lcom/ait/toolkit/sencha/ext/client/events/chart/RefreshEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.chart.RefreshEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
		...
		if (component) {
			component
					.addListener(
							...
							$entry(function(c) {
								var chart = @com.ait.toolkit.sencha.ext.client.ui.Chart::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
								return handler.@com.ait.toolkit.sencha.ext.client.events.chart.ChartEventHandler::onEvent(Lcom/ait/toolkit/sencha/ext/client/ui/Chart;)(chart);
							}));
		}
