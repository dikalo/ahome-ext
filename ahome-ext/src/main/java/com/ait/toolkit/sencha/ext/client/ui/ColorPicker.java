...
import com.ait.toolkit.sencha.ext.client.events.colorpicker.SelectHandler;
...
public class ColorPicker extends Component {
    ...
    private native void init()/*-{
		...
		@com.ait.toolkit.sencha.ext.client.ui.ColorPicker::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native HandlerRegistration addSelectHandler(SelectHandler handler)/*-{
		...
		var fn = function(cmp, color, e) {
			var picker = @com.ait.toolkit.sencha.ext.client.ui.ColorPicker::new(Lcom/google/gwt/core/client/JavaScriptObject;)(cmp);
			var event = @com.ait.toolkit.sencha.ext.client.events.colorpicker.SelectEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/ColorPicker;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(picker,color,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.colorpicker.SelectHandler::onSelect(Lcom/ait/toolkit/sencha/ext/client/events/colorpicker/SelectEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.colorpicker.SelectEvent::EVENT_NAME;
