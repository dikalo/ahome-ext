...
import com.ait.toolkit.sencha.ext.client.events.view.FocusChangeHandler;
import com.ait.toolkit.sencha.ext.client.events.view.HighlightItemHandler;
...
import com.ait.toolkit.sencha.ext.client.events.view.UnHighlightItemHandler;
 ...
 * 
 * The View uses an Ext.XTemplate as its internal templating mechanism, and is bound to an Ext.data.Store so that as the data in the store changes the view is automatically updated
 * to reflect the changes. The view also provides built-in behavior for many common events that can occur for its contained items including click, doubleclick, mouseover, mouseout,
 * etc. as well as a built-in selection model. In order to use these features, an itemSelector config must be provided for the View to determine what nodes it will be working with.
 */
public class DataView extends Component {
	...
	public native HandlerRegistration addFocusChangeHandler(FocusChangeHandler handler)/*-{
		...
		var fn = function(sm, o, n, e) {
			...
			var oldFocused = @com.ait.toolkit.data.client.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(oldFocused);
			var newFocused = @com.ait.toolkit.data.client.BaseModel::new(Lcom/google/gwt/core/client/JavaScriptObject;)(n);
			var event = @com.ait.toolkit.sencha.ext.client.events.view.FocusChangeEvent::new(Lcom/ait/toolkit/sencha/ext/client/selection/SelectionModel;Lcom/ait/toolkit/data/client/BaseModel;Lcom/ait/toolkit/data/client/BaseModel;Lcom/google/gwt/core/client/JavaScriptObject;)(sm,oldFocused,newFocused,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.view.FocusChangeHandler::onFocusChange(Lcom/ait/toolkit/sencha/ext/client/events/view/FocusChangeEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.view.FocusChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addHighlightItemHandler(HighlightItemHandler handler)/*-{
		...
		var fn = function(v, el, e) {
			...
			var event = @com.ait.toolkit.sencha.ext.client.events.view.HighlightItemEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/DataView;Lcom/ait/toolkit/sencha/shared/client/dom/ExtElement;Lcom/google/gwt/core/client/JavaScriptObject;)(view,element,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.view.HighlightItemHandler::onHighligthItem(Lcom/ait/toolkit/sencha/ext/client/events/view/HighlightItemEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.view.HighlightItemEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addUnHighlightItemHandler(UnHighlightItemHandler handler)/*-{
		...
		var fn = function(v, el, e) {
			var view = @com.ait.toolkit.sencha.ext.client.ui.DataView::new(Lcom/google/gwt/core/client/JavaScriptObject;)(v);
			var element = @com.ait.toolkit.sencha.shared.client.dom.ExtElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(el);
			var event = @com.ait.toolkit.sencha.ext.client.events.view.UnHighlightItemEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/DataView;Lcom/ait/toolkit/sencha/shared/client/dom/ExtElement;Lcom/google/gwt/core/client/JavaScriptObject;)(view,element,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.view.UnHighlightItemHandler::onUnHighligthItem(Lcom/ait/toolkit/sencha/ext/client/events/view/UnHighlightItemEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.view.UnHighlightItemEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
