...
import com.ait.toolkit.sencha.ext.client.events.form.BeforeCollapseHandler;
import com.ait.toolkit.sencha.ext.client.events.form.BeforeExpandHandler;
import com.ait.toolkit.sencha.ext.client.events.form.CollapseHandler;
import com.ait.toolkit.sencha.ext.client.events.form.ExpandHandler;
import com.ait.toolkit.sencha.ext.client.events.form.FieldSetBeforeCollapseHandler;
import com.ait.toolkit.sencha.ext.client.events.form.FieldSetBeforeExpandHandler;
...
public class FieldSet extends Container {
    ...
    private static native void init()/*-{
		...
		@com.ait.toolkit.sencha.ext.client.ui.FieldSet::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native HandlerRegistration addBeforeCollapseHandler(BeforeCollapseHandler handler)/*-{
		...
		var fn = function(f, e) {
			var fs = @com.ait.toolkit.sencha.ext.client.ui.FieldSet::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var event = @com.ait.toolkit.sencha.ext.client.events.form.BeforeCollapseEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/FieldSet;Lcom/google/gwt/core/client/JavaScriptObject;)(fs,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.form.BeforeCollapseHandler::onBeforeCollapse(Lcom/ait/toolkit/sencha/ext/client/events/form/BeforeCollapseEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.form.BeforeCollapseEvent::EVENT_NAME;
    ...
    public native void addBeforeCollapseHandler(FieldSetBeforeCollapseHandler handler)/*-{
		...
		if (component) {
			component
					.addListener(
							@com.ait.toolkit.sencha.ext.client.events.form.BeforeCollapseEvent::EVENT_NAME,
							$entry(function(fs) {
								var fieldSet = @com.ait.toolkit.sencha.ext.client.ui.FieldSet::new(Lcom/google/gwt/core/client/JavaScriptObject;)(fs);
								return handler.@com.ait.toolkit.sencha.ext.client.events.form.FieldSetBeforeCollapseHandler::onEvent(Lcom/ait/toolkit/sencha/ext/client/ui/FieldSet;)(fieldSet);
							}));
		}
    ...
    public native HandlerRegistration addBeforeExpandHandler(BeforeExpandHandler handler)/*-{
		...
		var fn = function(f, e) {
			var fs = @com.ait.toolkit.sencha.ext.client.ui.FieldSet::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var event = @com.ait.toolkit.sencha.ext.client.events.form.BeforeExpandEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/FieldSet;Lcom/google/gwt/core/client/JavaScriptObject;)(fs,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.form.BeforeExpandHandler::onBeforeExpand(Lcom/ait/toolkit/sencha/ext/client/events/form/BeforeExpandEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.form.BeforeExpandEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native void addBeforeExoandHandler(FieldSetBeforeExpandHandler handler)/*-{
		...
		if (component) {
			component
					.addListener(
							@com.ait.toolkit.sencha.ext.client.events.form.BeforeExpandEvent::EVENT_NAME,
							$entry(function(fs) {
								var fieldSet = @com.ait.toolkit.sencha.ext.client.ui.FieldSet::new(Lcom/google/gwt/core/client/JavaScriptObject;)(fs);
								return handler.@com.ait.toolkit.sencha.ext.client.events.form.FieldSetBeforeExpandHandler::onEvent(Lcom/ait/toolkit/sencha/ext/client/ui/FieldSet;)(fieldSet);
							}));
		}
    ...
    public native HandlerRegistration addCollapseHandler(CollapseHandler handler)/*-{
		...
		var fn = function(f, e) {
			var fs = @com.ait.toolkit.sencha.ext.client.ui.FieldSet::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var event = @com.ait.toolkit.sencha.ext.client.events.form.CollapseEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/FieldSet;Lcom/google/gwt/core/client/JavaScriptObject;)(fs,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.form.CollapseHandler::onCollapse(Lcom/ait/toolkit/sencha/ext/client/events/form/CollapseEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.form.CollapseEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addExpandHandler(ExpandHandler handler)/*-{
		...
		var fn = function(f, e) {
			var fs = @com.ait.toolkit.sencha.ext.client.ui.FieldSet::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var event = @com.ait.toolkit.sencha.ext.client.events.form.ExpandEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/FieldSet;Lcom/google/gwt/core/client/JavaScriptObject;)(fs,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.form.ExpandHandler::onExpand(Lcom/ait/toolkit/sencha/ext/client/events/form/ExpandEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.form.ExpandEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
