...
import com.ait.toolkit.sencha.ext.client.events.flash.FailureHandler;
import com.ait.toolkit.sencha.ext.client.events.flash.SuccessHandler;
...
public class FlashComponent extends Component {
    ...
    private native void init()/*-{
		...
		@com.ait.toolkit.sencha.ext.client.ui.FlashComponent::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native HandlerRegistration addFailureHandler(FailureHandler handler)/*-{
		...
		var fn = function(cmp, e) {
			var component = @com.ait.toolkit.sencha.ext.client.ui.FlashComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(cmp);
			var event = @com.ait.toolkit.sencha.ext.client.events.flash.FailureEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/FlashComponent;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.flash.FailureHandler::onFailure(Lcom/ait/toolkit/sencha/ext/client/events/flash/FailureEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.flash.FailureEvent::EVENT_NAME;
    ...
    public native HandlerRegistration addSuccessHandler(SuccessHandler handler)/*-{
		...
		var fn = function(cmp, e) {
			var component = @com.ait.toolkit.sencha.ext.client.ui.FlashComponent::new(Lcom/google/gwt/core/client/JavaScriptObject;)(cmp);
			var event = @com.ait.toolkit.sencha.ext.client.events.flash.SuccessEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/FlashComponent;Lcom/google/gwt/core/client/JavaScriptObject;)(component,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.flash.SuccessHandler::onSuccess(Lcom/ait/toolkit/sencha/ext/client/events/flash/SuccessEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.flash.SuccessEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
