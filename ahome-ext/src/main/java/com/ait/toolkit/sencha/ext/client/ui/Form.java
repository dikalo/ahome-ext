...
import com.ait.toolkit.sencha.ext.client.events.form.SubmitHandler;
import com.ait.toolkit.sencha.ext.client.field.Field;
import com.ait.toolkit.sencha.ext.client.field.FieldBase;
import com.ait.toolkit.sencha.shared.client.connection.Connection;
import com.ait.toolkit.sencha.shared.client.connection.UrlParam;
...
public class Form extends JsObject {
	...
	public native void checkDirty() /*-{
		var form = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		form.checkDirty();
	}-*/;
	...
	public native FieldBase findField(String id)/*-{
		...
		return fieldJS != null ? @com.ait.toolkit.sencha.ext.client.ui.ComponentFactory::getComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(fieldJS)
				: null;
	}-*/;
	 ...
	 */
	public native String getValuesAsString(boolean dirtyOnly,
			boolean includeEmptyText, boolean useDataValues) /*-{
		var form = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
	...
	public void load(String url, UrlParam[] params, Connection.Method method,
			String waitMsg) {
		JavaScriptObject configJS = JsoHelper.createObject();
		JsoHelper.setAttribute(configJS, "url", url);
	...
	public native void loadRecord(BaseModel record) /*-{
		var form = this.@com.ait.toolkit.core.client.JsObject::getJsObj()();
		var recordJS = record.@com.ait.toolkit.core.client.JsObject::getJsObj()();
	...
	public void submit(String url, SubmitHandler handler) {
		JavaScriptObject configJS = JsoHelper.createObject();
		JsoHelper.setAttribute(configJS, "url", url);
		JsoHelper.setAttribute(configJS, "success",
				_getSuccessCallback(handler));
		JsoHelper.setAttribute(configJS, "failure",
				_getFailureCallback(handler));
		submit(configJS);
	}
	...
	public void submit(String url, UrlParam[] params, Connection.Method method,
	...
	public void submit(String url, UrlParam[] params, Connection.Method method,
			String waitMsg, boolean clientValidation) {
		JavaScriptObject configJS = JsoHelper.createObject();
		JsoHelper.setAttribute(configJS, "url", url);
		if (params != null && params.length > 0) {
			JavaScriptObject paramObj = UrlParam.getJsObj(params);
	...
	public void submit(String url, UrlParam[] params, Connection.Method method,
			String waitMsg, boolean clientValidation, SubmitHandler handler) {
		JavaScriptObject configJS = JsoHelper.createObject();
		JsoHelper.setAttribute(configJS, "url", url);
		if (params != null && params.length > 0) {
			JavaScriptObject paramObj = UrlParam.getJsObj(params);
	...
	private native JavaScriptObject _getSubmitCallback(SubmitHandler handler)/*-{
		return {
			success : function(f, a) {
				var form = @com.ait.toolkit.sencha.ext.client.ui.Form::new(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
				var action = @com.ait.toolkit.sencha.ext.client.form.Action::new(Lcom/google/gwt/core/client/JavaScriptObject;)(a);
				handler.@com.ait.toolkit.sencha.ext.client.events.form.SubmitHandler::onSuccess(Lcom/ait/toolkit/sencha/ext/client/ui/Form;Lcom/ait/toolkit/sencha/ext/client/form/Action;)(form,action);
			},
			failure : function(f, a) {
				var form = @com.ait.toolkit.sencha.ext.client.ui.Form::new(Lcom/google/gwt/core/client/JavaScriptObject;)(f);
				var action = @com.ait.toolkit.sencha.ext.client.form.Action::new(Lcom/google/gwt/core/client/JavaScriptObject;)(a);
				handler.@com.ait.toolkit.sencha.ext.client.events.form.SubmitHandler::onFailure(Lcom/ait/toolkit/sencha/ext/client/ui/Form;Lcom/ait/toolkit/sencha/ext/client/form/Action;)(form,action);
			}
		};
	}-*/;
