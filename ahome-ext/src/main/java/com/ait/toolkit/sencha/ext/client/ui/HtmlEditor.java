...
public class HtmlEditor extends FieldBase {
    ...
    private static native void init()/*-{
		...
		@com.ait.toolkit.sencha.ext.client.ui.HtmlEditor::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native void execCmd(String cmd, String value) /*-{
		var he = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
