...
public class LoadMask extends Component {
    ...
    public native void hide(ExtElement animateTarget) /*-{
		var component = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
		component
				.hide(animateTarget.@com.ait.toolkit.sencha.shared.client.dom.ExtElement::getJsObj()());
    }-*/;
    ...
    public native void hide(ExtElement animateTarget, Function callback) /*-{
		...
		component
				.hide(
						animateTarget.@com.ait.toolkit.sencha.shared.client.dom.ExtElement::getJsObj()(),
						$entry(function() {
							callback.@com.ait.toolkit.core.client.Function::execute()();
						}));
    }-*/;
    ...
    public native void show(ExtElement animateTarget) /*-{
		var component = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
		component
				.show(animateTarget.@com.ait.toolkit.sencha.shared.client.dom.ExtElement::getJsObj()());
    }-*/;
