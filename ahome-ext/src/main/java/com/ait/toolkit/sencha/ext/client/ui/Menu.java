...
import com.ait.toolkit.sencha.ext.client.events.menu.ClickHandler;
import com.ait.toolkit.sencha.ext.client.events.menu.MouseEnterHandler;
import com.ait.toolkit.sencha.ext.client.events.menu.MouseLeaveHandler;
import com.ait.toolkit.sencha.ext.client.events.menu.MouseOverHandler;
...
public class Menu extends Panel {
    ...
    private native void init()/*-{
		...
		@com.ait.toolkit.sencha.ext.client.ui.Menu::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native Menu getParentMenu() /*-{
		var menu = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
    ...
    public native void showBy(Component component) /*-{
		var menu = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
		var target = component.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
		menu.showBy(target);
    }-*/;
    ...
    public native void doConstrain(ExtElement element) /*-{
		var menu = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
		menu
				.doConstrain(element.@com.ait.toolkit.core.client.JsObject::getJsObj()());
    }-*/;
    ...
    public native void doConstrain(Component element) /*-{
		var menu = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
		menu
				.doConstrain(element.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()());
    }-*/;
    ...
    public native HandlerRegistration AddClickHandler(ClickHandler handler)/*-{
		...
		var fn = function(m, c, e) {
			...
			var comp = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.menu.ClickEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/Menu;Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(menu,comp,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.menu.ClickHandler::onClick(Lcom/ait/toolkit/sencha/ext/client/events/menu/ClickEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.menu.ClickEvent::EVENT_NAME;
    ...
    public native HandlerRegistration addMouseleaveHandler(MouseLeaveHandler handler)/*-{
		...
		var fn = function(m, e) {
			var menu = @com.ait.toolkit.sencha.ext.client.ui.Menu::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var event = @com.ait.toolkit.sencha.ext.client.events.menu.MouseLeaveEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/Menu;Lcom/google/gwt/core/client/JavaScriptObject;)(menu,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.menu.MouseLeaveHandler::onMouseLeave(Lcom/ait/toolkit/sencha/ext/client/events/menu/MouseLeaveEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.menu.MouseLeaveEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addMouseEnterHandler(MouseEnterHandler handler)/*-{
		...
		var fn = function(m, e) {
			var menu = @com.ait.toolkit.sencha.ext.client.ui.Menu::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var event = @com.ait.toolkit.sencha.ext.client.events.menu.MouseEnterEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/Menu;Lcom/google/gwt/core/client/JavaScriptObject;)(menu,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.menu.MouseEnterHandler::onMouseEnter(Lcom/ait/toolkit/sencha/ext/client/events/menu/MouseEnterEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.menu.MouseEnterEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addMouseOverHandler(MouseOverHandler handler)/*-{
		...
		var fn = function(m, c, e) {
			var menu = @com.ait.toolkit.sencha.ext.client.ui.Menu::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var comp = @com.ait.toolkit.sencha.ext.client.core.Component::createComponent(Lcom/google/gwt/core/client/JavaScriptObject;)(c);
			var event = @com.ait.toolkit.sencha.ext.client.events.menu.MouseOverEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/Menu;Lcom/ait/toolkit/sencha/ext/client/core/Component;Lcom/google/gwt/core/client/JavaScriptObject;)(menu,comp,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.menu.MouseOverHandler::onMouseOver(Lcom/ait/toolkit/sencha/ext/client/events/menu/MouseOverEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.menu.MouseOverEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
