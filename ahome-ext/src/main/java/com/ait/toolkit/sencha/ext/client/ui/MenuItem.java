...
import com.ait.toolkit.sencha.ext.client.events.menu.ItemActivateHandler;
import com.ait.toolkit.sencha.ext.client.events.menu.ItemClickHandler;
import com.ait.toolkit.sencha.ext.client.events.menu.ItemDeactivateHandler;
import com.ait.toolkit.sencha.ext.client.events.menu.ItemIconChangeHandler;
import com.ait.toolkit.sencha.ext.client.events.menu.ItemTextChangeHandler;
...
public class MenuItem extends Component {
    ...
    private native void init()/*-{
		...
		@com.ait.toolkit.sencha.ext.client.ui.MenuItem::configPrototype = c.initialConfig;
    }-*/;
    ...
    public native Menu getMenu() /*-{
		...
		return @com.ait.toolkit.sencha.ext.client.ui.Menu::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
    }-*/;
    ...
    public native HandlerRegistration addItemActivateHandler(ItemActivateHandler handler)/*-{
		...
		var fn = function(m, e) {
			...
			var event = @com.ait.toolkit.sencha.ext.client.events.menu.ItemActivateEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/MenuItem;Lcom/google/gwt/core/client/JavaScriptObject;)(menu,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.menu.ItemActivateHandler::onItemActivate(Lcom/ait/toolkit/sencha/ext/client/events/menu/ItemActivateEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.menu.ItemActivateEvent::EVENT_NAME;
    ...
    public native HandlerRegistration addItemDeactivateHandler(ItemDeactivateHandler handler)/*-{
		...
		var fn = function(m, e) {
			var menu = @com.ait.toolkit.sencha.ext.client.ui.Menu::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var event = @com.ait.toolkit.sencha.ext.client.events.menu.ItemDeactivateEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/MenuItem;Lcom/google/gwt/core/client/JavaScriptObject;)(menu,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.menu.ItemDeactivateHandler::onItemDeactivate(Lcom/ait/toolkit/sencha/ext/client/events/menu/ItemDeactivateEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.menu.ItemDeactivateEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addItemClickHandler(ItemClickHandler handler)/*-{
		var component = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
		var fn = function(m, e) {
			var menu = @com.ait.toolkit.sencha.ext.client.ui.MenuItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var event = @com.ait.toolkit.sencha.ext.client.events.menu.ItemClickEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/MenuItem;Lcom/google/gwt/core/client/JavaScriptObject;)(menu,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.menu.ItemClickHandler::onItemClick(Lcom/ait/toolkit/sencha/ext/client/events/menu/ItemClickEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.menu.ItemClickEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addItemIconChangeHandler(ItemIconChangeHandler handler)/*-{
		...
		var fn = function(m, oldIcon, newIcon, e) {
			var menu = @com.ait.toolkit.sencha.ext.client.ui.MenuItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var event = @com.ait.toolkit.sencha.ext.client.events.menu.ItemIconChangeEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/MenuItem;Ljava/lang/String;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(menu,oldIcon,newIcon,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.menu.ItemIconChangeHandler::onItemIconChange(Lcom/ait/toolkit/sencha/ext/client/events/menu/ItemIconChangeEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.menu.ItemIconChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addItemTextChangeHandler(ItemTextChangeHandler handler)/*-{
		...
		var fn = function(m, oldText, newText, e) {
			var menu = @com.ait.toolkit.sencha.ext.client.ui.MenuItem::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
			var event = @com.ait.toolkit.sencha.ext.client.events.menu.ItemTextChangeEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/MenuItem;Ljava/lang/String;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(menu,oldText,newText,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.menu.ItemTextChangeHandler::onItemTextChange(Lcom/ait/toolkit/sencha/ext/client/events/menu/ItemTextChangeEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.menu.ItemTextChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
