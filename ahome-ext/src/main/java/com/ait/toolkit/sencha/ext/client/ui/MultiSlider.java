...
import com.ait.toolkit.sencha.ext.client.events.slider.BeforeChangeHandler;
import com.ait.toolkit.sencha.ext.client.events.slider.ChangeCompleteHandler;
import com.ait.toolkit.sencha.ext.client.events.slider.ChangeHandler;
import com.ait.toolkit.sencha.ext.client.events.slider.DragEndHandler;
import com.ait.toolkit.sencha.ext.client.events.slider.DragStartHandler;
import com.ait.toolkit.sencha.ext.client.events.slider.SliderBeforeChangeHandler;
import com.ait.toolkit.sencha.ext.client.field.FieldBase;
import com.ait.toolkit.sencha.ext.client.slider.SliderTip;
import com.ait.toolkit.sencha.ext.client.slider.Thumb;
import com.ait.toolkit.sencha.ext.client.slider.TipTextRenderer;
...
public class MultiSlider extends FieldBase {
	...
	public native HandlerRegistration addDragStartHandler(
		...
		var fn = function(slider, e) {
			...
			var event = @com.ait.toolkit.sencha.ext.client.events.slider.DragStartEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/MultiSlider;Lcom/google/gwt/core/client/JavaScriptObject;)(component, e);
			handler.@com.ait.toolkit.sencha.ext.client.events.slider.DragStartHandler::onDragStart(Lcom/ait/toolkit/sencha/ext/client/events/slider/DragStartEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.slider.DragStartEvent::EVENT_NAME;
	...
	public native HandlerRegistration addDragEndHandler(DragEndHandler handler)/*-{
		...
		var fn = function(slider, e) {
			var component = @com.ait.toolkit.sencha.ext.client.ui.MultiSlider::new(Lcom/google/gwt/core/client/JavaScriptObject;)(slider);
			var event = @com.ait.toolkit.sencha.ext.client.events.slider.DragEndEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/MultiSlider;Lcom/google/gwt/core/client/JavaScriptObject;)(component, e);
			handler.@com.ait.toolkit.sencha.ext.client.events.slider.DragEndHandler::onDragEnd(Lcom/ait/toolkit/sencha/ext/client/events/slider/DragEndEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.slider.DragEndEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addDragHandler(
		...
		var fn = function(slider, e) {
			var component = @com.ait.toolkit.sencha.ext.client.ui.MultiSlider::new(Lcom/google/gwt/core/client/JavaScriptObject;)(slider);
			var event = @com.ait.toolkit.sencha.ext.client.events.slider.DragEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/MultiSlider;Lcom/google/gwt/core/client/JavaScriptObject;)(component, e);
			handler.@com.ait.toolkit.sencha.ext.client.events.slider.DragHandler::onDrag(Lcom/ait/toolkit/sencha/ext/client/events/slider/DragEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.slider.DragEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addChangeHandler(ChangeHandler handler)/*-{
		...
		var fn = function(slider, newValue, t, e) {
			...
			var event = @com.ait.toolkit.sencha.ext.client.events.slider.ChangeEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/MultiSlider;DLcom/ait/toolkit/sencha/ext/client/slider/Thumb;Lcom/google/gwt/core/client/JavaScriptObject;)(compolent,thumb,newValue,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.slider.ChangeHandler::onChange(Lcom/ait/toolkit/sencha/ext/client/events/slider/ChangeEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.slider.ChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native HandlerRegistration addChangeHandler(
		...
		var fn = function(slider, newValue, t, e) {
			var component = @com.ait.toolkit.sencha.ext.client.ui.MultiSlider::new(Lcom/google/gwt/core/client/JavaScriptObject;)(slider);
			var thumb = @com.ait.toolkit.sencha.ext.client.slider.Thumb::new(Lcom/google/gwt/core/client/JavaScriptObject;)(t);
			var event = @com.ait.toolkit.sencha.ext.client.events.slider.ChangeCompleteEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/MultiSlider;DLcom/ait/toolkit/sencha/ext/client/slider/Thumb;Lcom/google/gwt/core/client/JavaScriptObject;)(compolent,thumb,newValue,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.slider.ChangeCompleteHandler::onChangeComplete(Lcom/ait/toolkit/sencha/ext/client/events/slider/ChangeCompleteEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.slider.ChangeCompleteEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
	}-*/;
	...
	public native void addBeforeChangeHandler(SliderBeforeChangeHandler handler)/*-{
		...
		if (component) {
			component
					.addListener(
							@com.ait.toolkit.sencha.ext.client.events.Event::BEFORE_CHANGE,
							$entry(function(m, newValue, oldValue) {
								var mutil = @com.ait.toolkit.sencha.ext.client.ui.MultiSlider::new(Lcom/google/gwt/core/client/JavaScriptObject;)(m);
								return handler.@com.ait.toolkit.sencha.ext.client.events.slider.SliderBeforeChangeHandler::onEvent(Lcom/ait/toolkit/sencha/ext/client/ui/MultiSlider;DD)(multi, oldValue, newValue);
							}));
		}
	...
	public native HandlerRegistration addBeforeChangeHandler(
		...
		var fn = function(slider, oldValue, newValue, e) {
			var component = @com.ait.toolkit.sencha.ext.client.ui.MultiSlider::new(Lcom/google/gwt/core/client/JavaScriptObject;)(slider);
			var event = @com.ait.toolkit.sencha.ext.client.events.slider.BeforeChangeEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/MultiSlider;DDLcom/google/gwt/core/client/JavaScriptObject;)(component,oldValue,newValue,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.slider.BeforeChangeHandler::onBeforeChange(Lcom/ait/toolkit/sencha/ext/client/events/slider/BeforeChangeEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.slider.BeforeChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
