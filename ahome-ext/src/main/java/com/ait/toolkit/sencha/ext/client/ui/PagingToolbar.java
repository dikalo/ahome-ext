...
import com.ait.toolkit.sencha.ext.client.events.toolbar.BeforeChangeHandler;
import com.ait.toolkit.sencha.ext.client.events.toolbar.ChangeHandler;
import com.ait.toolkit.sencha.ext.client.events.toolbar.PagingToolbarBeforeChangeHandler;
...
public class PagingToolbar extends ToolBar {
    ...
    public native void updateInfo() /*-{
		var pagingToolbar = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
    ...
    public native HandlerRegistration addChangeHandler(ChangeHandler handler)/*-{
		...
		var fn = function(t, d, e) {
			var pt = @com.ait.toolkit.sencha.ext.client.ui.PagingToolbar::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
			var data = @com.ait.toolkit.sencha.ext.client.toolbar.PageData::new(Lcom/google/gwt/core/client/JavaScriptObject;)(d);
			var event = @com.ait.toolkit.sencha.ext.client.events.toolbar.ChangeEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/PagingToolbar;Lcom/ait/toolkit/sencha/ext/client/toolbar/PageData;Lcom/google/gwt/core/client/JavaScriptObject;)(pt,data,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.toolbar.ChangeHandler::onChange(Lcom/ait/toolkit/sencha/ext/client/events/toolbar/ChangeEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.toolbar.ChangeEvent::EVENT_NAME;
			...
			component
					.addListener(
							...
							$entry(function(p, page) {
								var pt = @com.ait.toolkit.sencha.ext.client.ui.PagingToolbar::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
								handler.@com.ait.toolkit.sencha.ext.client.events.toolbar.PagingToolbarBeforeChangeHandler::onEvent(Lcom/ait/toolkit/sencha/ext/client/ui/PagingToolbar;I)(pt,index);
							}));
		}
    ...
    public native HandlerRegistration addBeforeChangeHandler(BeforeChangeHandler handler)/*-{
		...
		var fn = function(t, page, e) {
			var pt = @com.ait.toolkit.sencha.ext.client.ui.PagingToolbar::new(Lcom/google/gwt/core/client/JavaScriptObject;)(p);
			var event = @com.ait.toolkit.sencha.ext.client.events.toolbar.BeforeChangeEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/PagingToolbar;DLcom/google/gwt/core/client/JavaScriptObject;)(pt,page,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.toolbar.BeforeChangeHandler::onBeforeChange(Lcom/ait/toolkit/sencha/ext/client/events/toolbar/BeforeChangeEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.toolbar.BeforeChangeEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
