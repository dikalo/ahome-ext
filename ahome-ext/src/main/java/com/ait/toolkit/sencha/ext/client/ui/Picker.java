...
public abstract class Picker extends TriggerField {
    ...
    public native HandlerRegistration addCollapseHandler(
                    com.ait.toolkit.sencha.ext.client.events.form.PickerCollapseHandler handler)/*-{
		var component = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
		var fn = function(p, e) {
			var picker = @com.ait.toolkit.sencha.ext.client.ui.Picker::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);

			var event = @com.ait.toolkit.sencha.ext.client.events.form.PickerCollapseEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/Picker;Lcom/google/gwt/core/client/JavaScriptObject;)(picker,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.form.PickerCollapseHandler::onPickerCollapse(Lcom/ait/toolkit/sencha/ext/client/events/form/PickerCollapseEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.form.PickerCollapseEvent::EVENT_NAME;
     ...
     */
    public native HandlerRegistration addExpandHandler(com.ait.toolkit.sencha.ext.client.events.form.PickerExpandHandler handler)/*-{
		var component = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
		var fn = function(p, e) {
			var picker = @com.ait.toolkit.sencha.ext.client.ui.Picker::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);

			var event = @com.ait.toolkit.sencha.ext.client.events.form.PickerExpandEvent::new(Lcom/ait/toolkit/sencha/ext/client/ui/Picker;Lcom/google/gwt/core/client/JavaScriptObject;)(picker,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.form.PickerExpandHandler::onPickerExpand(Lcom/ait/toolkit/sencha/ext/client/events/form/PickerExpandEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.form.PickerExpandEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
    ...
    public native HandlerRegistration addFieldSelectHandler(
                    com.ait.toolkit.sencha.ext.client.events.form.FieldSelectHandler handler)/*-{
		var component = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
		var fn = function(p, value, e) {
			var picker = @com.ait.toolkit.sencha.ext.client.ui.Picker::new(Lcom/google/gwt/core/client/JavaScriptObject;)(c);

			var event = @com.ait.toolkit.sencha.ext.client.events.form.FieldSelectEvent::new(Lcom/ait/toolkit/sencha/ext/client/field/FieldBase;Ljava/lang/Object;Lcom/google/gwt/core/client/JavaScriptObject;)(picker,value,e);
			handler.@com.ait.toolkit.sencha.ext.client.events.form.FieldSelectHandler::onFieldSelect(Lcom/ait/toolkit/sencha/ext/client/events/form/FieldSelectEvent;)(event);
		};
		var eventName = @com.ait.toolkit.sencha.ext.client.events.form.FieldSelectEvent::EVENT_NAME;
		component.addListener(eventName, fn);
		var toReturn = @com.ait.toolkit.sencha.ext.client.events.HandlerRegistration::new(Lcom/ait/toolkit/sencha/ext/client/core/Component;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(this,eventName,fn);
		return toReturn;
    }-*/;
