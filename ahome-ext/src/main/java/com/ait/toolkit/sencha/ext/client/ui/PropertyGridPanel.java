...
public class PropertyGridPanel extends GridPanel {
    ...
    private native void init()/*-{
		...
		@com.ait.toolkit.sencha.ext.client.ui.PropertyGridPanel::configPrototype = c.initialConfig;
    }-*/;
    ...
    protected native JavaScriptObject create(JavaScriptObject config) /*-{
		var dd = this.@com.ait.toolkit.sencha.ext.client.ui.GridPanel::dd;
		if (dd) {
			var peer = dd.@com.ait.toolkit.core.client.JsObject::getJsObj()();
    ...
    private native void _setSource(BaseModel source)/*-{
		var jso = this.@com.ait.toolkit.sencha.ext.client.core.Component::getOrCreateJsObj()();
		jso
				.setSource(source.@com.ait.toolkit.core.client.JsObject::getJsObj()());
    }-*/;
