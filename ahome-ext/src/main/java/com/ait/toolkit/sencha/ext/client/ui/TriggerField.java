...
public class TriggerField extends TextField {
	...
	private native void setup(TriggerField triggerField, JavaScriptObject jsObj) /*-{
		jsObj.onTriggerClick = function(event) {
			...
			triggerField.@com.ait.toolkit.sencha.ext.client.ui.TriggerField::onTriggerClick(Lcom/ait/toolkit/sencha/shared/client/core/EventObject;)(e);
		}
	}-*/;
	...
	public native CompositeElement getTriggerEl() /*-{
		...
		return @com.ait.toolkit.sencha.shared.client.dom.CompositeElement::new(Lcom/google/gwt/core/client/JavaScriptObject;)(obj);
	}-*/;
