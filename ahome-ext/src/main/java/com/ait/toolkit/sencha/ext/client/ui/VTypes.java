 ...
 * extended.
 * 
 * @see com.ait.toolkit.sencha.ext.client.ui.TextField#setVtype(VTypes)
 */
public class VTypes {
	...
	public static native void setAlphaMask(RegExp alphaMask)/*-{
		var re = alphaMask.@com.ait.toolkit.core.client.JsObject::getJsObj()();
	...
	public static native void setAlphanumMask(RegExp alphanumMask)/*-{
		var re = alphanumMask.@com.ait.toolkit.core.client.JsObject::getJsObj()();
	...
	public static native void setEmailMask(RegExp emailMask)/*-{
		var re = emailMask.@com.ait.toolkit.core.client.JsObject::getJsObj()();
